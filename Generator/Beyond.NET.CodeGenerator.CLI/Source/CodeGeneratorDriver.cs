...
internal class CodeGeneratorDriver
{
        ...
        try {
            ...
            if (!doNotGenerateDocumentation) {
                ...
                if (string.IsNullOrEmpty(systemReferenceAssembliesDirectoryPath) ||
                    ...
                    // TODO(nil4): update to .NET 10 SDK RTM (November)
                    systemReferenceAssembliesDirectoryPath = "/usr/local/share/dotnet/packs/Microsoft.NETCore.App.Ref/10.0.0-rc.2.25502.107/ref/net10.0";
    ...
    )
    {
        ...
        // ref. https://learn.microsoft.com/dotnet/fundamentals/code-analysis/configuration-options#exclude-generated-code
        // ref. https://github.com/dotnet/runtime/issues/64541

        // Suppress warnings in generated code.
        // ref. https://github.com/dotnet/runtime/pull/120181/files#diff-b7da6b90947be2bdebc35f367d9dc2c5bb66dd3be881af8a2d6cbb9c18108a7fR140-R160
        // ref. https://github.com/dotnet/runtime/issues/119451
        // ref. https://github.com/dotnet/runtime/pull/120196
        //    We suppress all diagnostics stemming from the generated code.
        //    There's nothing a developer can do about these diagnostics, and they can break the build.

        // Enable nullable annotations (if present) but ignore all related warnings.
        // ref. https://learn.microsoft.com/dotnet/csharp/nullable-references#nullable-contexts
        //   Important
        //   The global nullable context does not apply for generated code files. Under either strategy,
