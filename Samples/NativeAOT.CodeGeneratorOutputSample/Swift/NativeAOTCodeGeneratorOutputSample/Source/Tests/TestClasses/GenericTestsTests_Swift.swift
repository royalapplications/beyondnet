...
final class GenericTestsTests_Swift: XCTestCase {
	...
	func testReturnGenericTypeAsOutParameter() {
		...
		XCTAssertNoThrow(try NativeAOT_CodeGeneratorInputSample_GenericTests.returnGenericTypeAsOutParameter(genericType,
																											 &typeRet))
	...
	func testReturnGenericTypeAsRefParameter() {
		...
		XCTAssertNoThrow(try NativeAOT_CodeGeneratorInputSample_GenericTests.returnGenericTypeAsRefParameter(genericType,
																											 &typeRet))
	...
	func testReturnArrayOfDefaultValuesOfGenericType() {
		...
		guard let defaultValuesArrayRet = try? NativeAOT_CodeGeneratorInputSample_GenericTests.returnArrayOfDefaultValuesOfGenericType(genericType,
	...
	func testReturnArrayOfRepeatedValues() {
		...
		guard let genericTests = try? NativeAOT_CodeGeneratorInputSample_GenericTests() else {
	...
	func testReturnSimpleKeyValuePair() {
		...
		guard let keyValuePair = try? NativeAOT_CodeGeneratorInputSample_GenericTests.returnSimpleKeyValuePair(keyType,
																											   valueType,
																											   key,
																											   value) else {
	...
	func testIncorrectParametersInGenericMethod() {
		...
		do {
			_ = try NativeAOT_CodeGeneratorInputSample_GenericTests.returnSimpleKeyValuePair(keyType,
																							 valueType,
																							 key,
																							 value)
	...
	func testReturnStringOfJoinedArray() {
		...
		guard let stringRet = try? NativeAOT_CodeGeneratorInputSample_GenericTests.returnStringOfJoinedArray(stringType,
																											 arrayOfStrings,
