...
final class GenericTestClassTests: XCTestCase {
	...
	func testWith1GenericArgument() {
		...
		guard let genericArgumentType = NativeAOT_CodeGeneratorInputSample_GenericTestClass_A1_ReturnGenericClassType(genericTestClass,
																													  systemStringType,
																													  &exception),
			  exception == nil else {
		...
		NativeAOT_CodeGeneratorInputSample_GenericTestClass_A1_AProperty_Set(genericTestClass,
																			 systemStringType,
																			 value,
																			 &exception)
		...
		let propValueRet = NativeAOT_CodeGeneratorInputSample_GenericTestClass_A1_AProperty_Get(genericTestClass,
																								systemStringType,
																								&exception)
		...
		NativeAOT_CodeGeneratorInputSample_GenericTestClass_A1_AField_Set(genericTestClass,
																		  systemStringType,
																		  value)
		
		XCTAssertNil(exception)
		
		let fieldValueRet = NativeAOT_CodeGeneratorInputSample_GenericTestClass_A1_AField_Get(genericTestClass,
																							  systemStringType)
	...
	func testWith2GenericArguments() {
		...
		guard let genericArgumentTypes = NativeAOT_CodeGeneratorInputSample_GenericTestClass_A2_ReturnGenericClassTypes(genericTestClass,
																														systemStringType,
																														systemExceptionType,
																														&exception),
			  exception == nil else {
		...
		NativeAOT_CodeGeneratorInputSample_GenericTestClass_A2_AProperty_Set(genericTestClass,
																			 systemStringType,
																			 systemExceptionType,
																			 value,
																			 &exception)
		...
		let propValueRet = NativeAOT_CodeGeneratorInputSample_GenericTestClass_A2_AProperty_Get(genericTestClass,
																								systemStringType,
																								systemExceptionType,
																								&exception)
		...
		NativeAOT_CodeGeneratorInputSample_GenericTestClass_A2_AField_Set(genericTestClass,
																		  systemStringType,
																		  systemExceptionType,
																		  value)
		...
		let fieldValueRet = NativeAOT_CodeGeneratorInputSample_GenericTestClass_A2_AField_Get(genericTestClass,
																							  systemStringType,
																							  systemExceptionType)
