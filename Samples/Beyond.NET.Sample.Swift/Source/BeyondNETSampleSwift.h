...
#ifndef BeyondNETSampleSwift_h
#define BeyondNETSampleSwift_h

//! Project version number for BeyondNETSampleSwift.
FOUNDATION_EXPORT double BeyondNETSampleSwiftVersionNumber;

//! Project version string for BeyondNETSampleSwift.
