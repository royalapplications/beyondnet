...
final class GenericTestsTests: XCTestCase {
	...
	func testReturnGenericTypeWithReferenceType() {
		...
		guard let typeRet = Beyond_NET_Sample_GenericTests_ReturnGenericType_A1(genericType,
																								 &exception),
			  exception == nil else {
	...
	func testReturnGenericTypeWithValueType() {
		...
		let typeRet = Beyond_NET_Sample_GenericTests_ReturnGenericType_A1(genericType,
																						   &exception)
	...
	func testReturnGenericTypeAsOutParameter() {
		...
		Beyond_NET_Sample_GenericTests_ReturnGenericTypeAsOutParameter_A1(genericType,
																						   &typeRet,
																						   &exception)
	...
	func testReturnGenericTypeAsRefParameter() {
		...
		Beyond_NET_Sample_GenericTests_ReturnGenericTypeAsRefParameter_A1(genericType,
																						   &typeRet,
																						   &exception)
	...
	func testReturnGenericTypes() {
		...
		guard let typesArrayRet = Beyond_NET_Sample_GenericTests_ReturnGenericTypes_A2(genericType1,
																										genericType2,
																										&exception),
			  exception == nil else {
	...
	func testReturnDefaultValueOfGenericType() {
		...
		let defaultValueRet = Beyond_NET_Sample_GenericTests_ReturnDefaultValueOfGenericType_A1(genericType,
																												 &exception)
	...
	func testReturnArrayOfDefaultValuesOfGenericType() {
		...
		guard let defaultValuesArrayRet = Beyond_NET_Sample_GenericTests_ReturnArrayOfDefaultValuesOfGenericType_A1(genericType,
																																	 numberOfElements,
																																	 &exception),
			  exception == nil else {
	...
	func testReturnArrayOfRepeatedValues() {
		...
		guard let genericTests = Beyond_NET_Sample_GenericTests_Create(&exception),
			  exception == nil else {
		...
		defer { Beyond_NET_Sample_GenericTests_Destroy(genericTests) }

		guard let arrayRet = Beyond_NET_Sample_GenericTests_ReturnArrayOfRepeatedValues_A1(genericTests,
																											systemObjectType,
																											value,
																											numberOfElements,
																											&exception),
	...
	func testReturnSimpleKeyValuePair() {
		...
		guard let keyValuePair = Beyond_NET_Sample_GenericTests_ReturnSimpleKeyValuePair_A2(keyType,
																											 valueType,
																											 key,
																											 value,
																											 &exception),
		...
		defer { Beyond_NET_Sample_GenericTests_SimpleKeyValuePair_Destroy(keyValuePair) }
		
		guard let keyRet = Beyond_NET_Sample_GenericTests_SimpleKeyValuePair_Key_Get(keyValuePair,
																									  &exception),
			  exception == nil else {
		...
		guard let valueRet = Beyond_NET_Sample_GenericTests_SimpleKeyValuePair_Value_Get(keyValuePair,
																										  &exception),
			  exception == nil else {
	...
	func testIncorrectParametersInGenericMethod() {
		...
		let keyValuePair = Beyond_NET_Sample_GenericTests_ReturnSimpleKeyValuePair_A2(keyType,
																									   valueType,
																									   key,
																									   value,
																									   &exception)
		...
		defer {
			if let keyValuePair {
				Beyond_NET_Sample_GenericTests_SimpleKeyValuePair_Destroy(keyValuePair)
			}
		}
	...
	func testReturnStringOfJoinedArray() {
		...
		guard let stringRet = String(cDotNETString: Beyond_NET_Sample_GenericTests_ReturnStringOfJoinedArray_A1(stringType,
																																arrayOfStrings,
																																separatorDN,
																																&exception),
									 destroyDotNETString: true),
    ...
    func testConstructedGenericListOfStrings() {
        ...
        guard let listOfStrings = Beyond_NET_Sample_GenericTests_ListOfStrings_Get(genericTests,
                                                                                                    &exception),
              exception == nil else {
